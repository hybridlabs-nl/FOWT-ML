# `fowt_ml` developer documentation
...
# install fowt_ml as an editable package
...
cd $(mktemp -d fowt_ml.XXXXXX)
git clone git@github.com:hybridlabs-nl/fowt_ml .
...
Visit
[https://test.pypi.org/project/fowt_ml](https://test.pypi.org/project/fowt_ml)
and verify that your package was uploaded successfully. Keep the terminal open, we'll need it later.

In a new terminal, without an activated virtual environment or an env directory:

```shell
cd $(mktemp -d fowt_ml-test.XXXXXX)
...
--extra-index-url https://pypi.org/simple fowt_ml
```
...
Don't forget to also make a [release on GitHub](https://github.com/hybridlabs-nl/fowt_ml/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.
